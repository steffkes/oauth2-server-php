...
/**
 * Factory for other classes in the OAuth framework
 * This class serves only to create the other Controller and Storage classes
 *
 * @see OAuth2_Controller_ResourceController
 * @see OAuth2_Controller_AuthorizeController
 * @see OAuth2_Controller_TokenController
 */
class OAuth2_ServerFactory
{
    // misc properties
    protected $response;
    protected $config;
    ...
    public function getServer()
    {
        ...
        $server->setAuthorizeController($this->getAuthorizeController());
        $server->setTokenController($this->getTokenController());
        $server->setResourceController($this->getResourceController());
